...
import com.showka.service.persistence.u05.UriagePersistenceImpl;
...
public class UriagePersistenceImplTest extends PersistenceTestCase {
		...
		new Expectations() {
			{
				...
				result = kokyaku01;
				// 明細削除
				uriageMeisaiPersistence.overrideList("r-KK01-00001", (List<UriageMeisai>) any);
				// cancel 履歴
				uriageRirekiPersistence.save((Uriage) any);
				// cancel
				uriageCancelPersistence.save((Uriage) any);
			}
		};
		// do
		TUriagePK pk = new TUriagePK();
	...
	public void test11_revert() throws Exception {
		...
		new Expectations() {
			{
				uriageRirekiPersistence.getUriageRirekiList("r-KK01-00001");
				result = rireki;
