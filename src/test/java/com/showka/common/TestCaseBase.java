...
public abstract class TestCaseBase extends TestCase {
	...
	// 売掛未請求
	protected static final String S_URIKAKE_SEIKYU_NOT_YET = "s_urikake_seikyu_not_yet";
	protected static final String[] S_URIKAKE_SEIKYU_NOT_YET_COLUMN = { "urikake_id", "record_id" };
	...
	// 請求売掛
	protected static final String S_URIKAKE_SEIKYU_DONE = "S_URIKAKE_SEIKYU_DONE";
	protected static final String[] S_URIKAKE_SEIKYU_DONE_COLUMN = { "urikake_id", "seikyu_id", "record_id" };
