...
public interface UriageRirekiMeisaiCrudService extends CrudService<UriageMeisai, RUriageMeisaiPK> {
	 ...
	 *            売上明細
	 */
	public void overrideList(List<UriageMeisai> uriageMeisaiList);
