...
import com.showka.table.public_.tables.S_URIKAKE_SEIKYU_NOT_YET;
...
public class Keys {
    ...
    public static final UniqueKey<S_URIKAKE_SEIKYU_DONE_RECORD> CONSTRAINT_50 = UniqueKeys0.CONSTRAINT_50;
    public static final UniqueKey<S_URIKAKE_SEIKYU_DONE_RECORD> UK_HGYB1F2BULW8F6P5LNW5GIGT4 = UniqueKeys0.UK_HGYB1F2BULW8F6P5LNW5GIGT4;
    public static final UniqueKey<S_URIKAKE_SEIKYU_NOT_YET_RECORD> CONSTRAINT_A = UniqueKeys0.CONSTRAINT_A;
    public static final UniqueKey<S_URIKAKE_SEIKYU_NOT_YET_RECORD> UK_A2658D83SSS5EQ43TO18F58KM = UniqueKeys0.UK_A2658D83SSS5EQ43TO18F58KM;
    ...
    public static final UniqueKey<T_NYUKIN_KEIJO_RECORD> CONSTRAINT_AB = UniqueKeys0.CONSTRAINT_AB;
    public static final UniqueKey<T_NYUKIN_KEIJO_RECORD> UK_7FTKDIPN53A5HD1RJSIXU46CX = UniqueKeys0.UK_7FTKDIPN53A5HD1RJSIXU46CX;
    ...
    public static final UniqueKey<W_FIRM_BANK_FURIKOMI_MATCHING_RECORD> CONSTRAINT_AF = UniqueKeys0.CONSTRAINT_AF;
    ...
    public static final ForeignKey<M_BUSHO_DATE_RECORD, M_BUSHO_RECORD> FKGXC449BRRDHF0MG5G35R1DIFS = ForeignKeys0.FKGXC449BRRDHF0MG5G35R1DIFS;
    ...
    public static final ForeignKey<S_URIKAKE_SEIKYU_DONE_RECORD, T_URIKAKE_RECORD> FKE5CMEL9P0EG4UOHYTK5WON16N = ForeignKeys0.FKE5CMEL9P0EG4UOHYTK5WON16N;
    public static final ForeignKey<S_URIKAKE_SEIKYU_DONE_RECORD, T_SEIKYU_RECORD> FKQ3D3EH9H7F43L7AGT956MKNRP = ForeignKeys0.FKQ3D3EH9H7F43L7AGT956MKNRP;
    public static final ForeignKey<S_URIKAKE_SEIKYU_NOT_YET_RECORD, T_URIKAKE_RECORD> FKJX3SBDLEAUMCJDCMDMMOETURW = ForeignKeys0.FKJX3SBDLEAUMCJDCMDMMOETURW;
    ...
    public static final ForeignKey<T_NYUKIN_KEIJO_RECORD, T_NYUKIN_RECORD> FK80XPBJ909GB86UGLEL2XEA4R4 = ForeignKeys0.FK80XPBJ909GB86UGLEL2XEA4R4;
    public static final ForeignKey<T_NYUKIN_KEIJO_RECORD, M_BUSHO_RECORD> FKPXUCUBJGIHRXJ2I03R13JN4AJ = ForeignKeys0.FKPXUCUBJGIHRXJ2I03R13JN4AJ;
    ...
    public static final ForeignKey<T_SHOHIN_ZAIKO_RECORD, M_BUSHO_RECORD> FK37YCTILUBSTKRUSDFLVWDLRUE = ForeignKeys0.FK37YCTILUBSTKRUSDFLVWDLRUE;
    ...
    private static class UniqueKeys0 {
        ...
        public static final UniqueKey<S_URIKAKE_SEIKYU_DONE_RECORD> CONSTRAINT_50 = Internal.createUniqueKey(S_URIKAKE_SEIKYU_DONE.s_urikake_seikyu_done, "CONSTRAINT_50", S_URIKAKE_SEIKYU_DONE.s_urikake_seikyu_done.urikake_id);
        public static final UniqueKey<S_URIKAKE_SEIKYU_DONE_RECORD> UK_HGYB1F2BULW8F6P5LNW5GIGT4 = Internal.createUniqueKey(S_URIKAKE_SEIKYU_DONE.s_urikake_seikyu_done, "UK_HGYB1F2BULW8F6P5LNW5GIGT4", S_URIKAKE_SEIKYU_DONE.s_urikake_seikyu_done.record_id);
        public static final UniqueKey<S_URIKAKE_SEIKYU_NOT_YET_RECORD> CONSTRAINT_A = Internal.createUniqueKey(S_URIKAKE_SEIKYU_NOT_YET.s_urikake_seikyu_not_yet, "CONSTRAINT_A", S_URIKAKE_SEIKYU_NOT_YET.s_urikake_seikyu_not_yet.urikake_id);
        public static final UniqueKey<S_URIKAKE_SEIKYU_NOT_YET_RECORD> UK_A2658D83SSS5EQ43TO18F58KM = Internal.createUniqueKey(S_URIKAKE_SEIKYU_NOT_YET.s_urikake_seikyu_not_yet, "UK_A2658D83SSS5EQ43TO18F58KM", S_URIKAKE_SEIKYU_NOT_YET.s_urikake_seikyu_not_yet.record_id);
        ...
        public static final UniqueKey<T_NYUKIN_KEIJO_RECORD> CONSTRAINT_AB = Internal.createUniqueKey(T_NYUKIN_KEIJO.t_nyukin_keijo, "CONSTRAINT_AB", T_NYUKIN_KEIJO.t_nyukin_keijo.nyukin_id);
        public static final UniqueKey<T_NYUKIN_KEIJO_RECORD> UK_7FTKDIPN53A5HD1RJSIXU46CX = Internal.createUniqueKey(T_NYUKIN_KEIJO.t_nyukin_keijo, "UK_7FTKDIPN53A5HD1RJSIXU46CX", T_NYUKIN_KEIJO.t_nyukin_keijo.record_id);
        ...
        public static final UniqueKey<W_FIRM_BANK_FURIKOMI_MATCHING_RECORD> CONSTRAINT_AF = Internal.createUniqueKey(W_FIRM_BANK_FURIKOMI_MATCHING.w_firm_bank_furikomi_matching, "CONSTRAINT_AF", W_FIRM_BANK_FURIKOMI_MATCHING.w_firm_bank_furikomi_matching.fb_furikomi_id, W_FIRM_BANK_FURIKOMI_MATCHING.w_firm_bank_furikomi_matching.furiwake_id);
    ...
    private static class ForeignKeys0 {
        ...
        public static final ForeignKey<M_BUSHO_DATE_RECORD, M_BUSHO_RECORD> FKGXC449BRRDHF0MG5G35R1DIFS = Internal.createForeignKey(com.showka.table.public_.Keys.UK_5BY1GUP4TXK8FK16KGF8MPF38, M_BUSHO_DATE.m_busho_date, "FKGXC449BRRDHF0MG5G35R1DIFS", M_BUSHO_DATE.m_busho_date.busho_id);
        ...
        public static final ForeignKey<S_URIKAKE_SEIKYU_DONE_RECORD, T_URIKAKE_RECORD> FKE5CMEL9P0EG4UOHYTK5WON16N = Internal.createForeignKey(com.showka.table.public_.Keys.UK_3RCPSMXXRKKRO42FWTDIPIAXB, S_URIKAKE_SEIKYU_DONE.s_urikake_seikyu_done, "FKE5CMEL9P0EG4UOHYTK5WON16N", S_URIKAKE_SEIKYU_DONE.s_urikake_seikyu_done.urikake_id);
        public static final ForeignKey<S_URIKAKE_SEIKYU_DONE_RECORD, T_SEIKYU_RECORD> FKQ3D3EH9H7F43L7AGT956MKNRP = Internal.createForeignKey(com.showka.table.public_.Keys.UK_4SCPAF4QMJRAM1VXMKUYJ269J, S_URIKAKE_SEIKYU_DONE.s_urikake_seikyu_done, "FKQ3D3EH9H7F43L7AGT956MKNRP", S_URIKAKE_SEIKYU_DONE.s_urikake_seikyu_done.seikyu_id);
        public static final ForeignKey<S_URIKAKE_SEIKYU_NOT_YET_RECORD, T_URIKAKE_RECORD> FKJX3SBDLEAUMCJDCMDMMOETURW = Internal.createForeignKey(com.showka.table.public_.Keys.UK_3RCPSMXXRKKRO42FWTDIPIAXB, S_URIKAKE_SEIKYU_NOT_YET.s_urikake_seikyu_not_yet, "FKJX3SBDLEAUMCJDCMDMMOETURW", S_URIKAKE_SEIKYU_NOT_YET.s_urikake_seikyu_not_yet.urikake_id);
        ...
        public static final ForeignKey<T_NYUKIN_KEIJO_RECORD, T_NYUKIN_RECORD> FK80XPBJ909GB86UGLEL2XEA4R4 = Internal.createForeignKey(com.showka.table.public_.Keys.UK_L792YLAIHK8HQ7S2FG0EPWB70, T_NYUKIN_KEIJO.t_nyukin_keijo, "FK80XPBJ909GB86UGLEL2XEA4R4", T_NYUKIN_KEIJO.t_nyukin_keijo.nyukin_id);
        public static final ForeignKey<T_NYUKIN_KEIJO_RECORD, M_BUSHO_RECORD> FKPXUCUBJGIHRXJ2I03R13JN4AJ = Internal.createForeignKey(com.showka.table.public_.Keys.UK_5BY1GUP4TXK8FK16KGF8MPF38, T_NYUKIN_KEIJO.t_nyukin_keijo, "FKPXUCUBJGIHRXJ2I03R13JN4AJ", T_NYUKIN_KEIJO.t_nyukin_keijo.busho_id);
        ...
        public static final ForeignKey<T_SHOHIN_ZAIKO_RECORD, M_BUSHO_RECORD> FK37YCTILUBSTKRUSDFLVWDLRUE = Internal.createForeignKey(com.showka.table.public_.Keys.UK_5BY1GUP4TXK8FK16KGF8MPF38, T_SHOHIN_ZAIKO.t_shohin_zaiko, "FK37YCTILUBSTKRUSDFLVWDLRUE", T_SHOHIN_ZAIKO.t_shohin_zaiko.busho_id);
