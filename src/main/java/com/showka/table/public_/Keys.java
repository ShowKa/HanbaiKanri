...
public class Keys {
    ...
    public static final UniqueKey<T_NYUKIN_KEIJO_RECORD> CONSTRAINT_A = UniqueKeys0.CONSTRAINT_A;
    ...
    public static final UniqueKey<T_URIKAKE_MISEIKYU_RECORD> CONSTRAINT_BB = UniqueKeys0.CONSTRAINT_BB;
    public static final UniqueKey<T_URIKAKE_MISEIKYU_RECORD> UK_QQQ9XMCG11YHYLQRK9YA2XCVV = UniqueKeys0.UK_QQQ9XMCG11YHYLQRK9YA2XCVV;
    public static final UniqueKey<T_URIKAKE_SEIKYU_RECORD> CONSTRAINT_3 = UniqueKeys0.CONSTRAINT_3;
    public static final UniqueKey<T_URIKAKE_SEIKYU_RECORD> UK_HYXD5QG5HAQQWADYTUFGUG75 = UniqueKeys0.UK_HYXD5QG5HAQQWADYTUFGUG75;
    ...
    public static final ForeignKey<T_URIKAKE_MISEIKYU_RECORD, T_URIKAKE_RECORD> FKLBHEN31UWEW3FUTAVYU3EA9UI = ForeignKeys0.FKLBHEN31UWEW3FUTAVYU3EA9UI;
    public static final ForeignKey<T_URIKAKE_SEIKYU_RECORD, T_URIKAKE_RECORD> FKR1R0G487FGYWJ0QDOO4YYA62U = ForeignKeys0.FKR1R0G487FGYWJ0QDOO4YYA62U;
    public static final ForeignKey<T_URIKAKE_SEIKYU_RECORD, T_SEIKYU_RECORD> FKHD30FFJT4R86SLV5YETDBV6JN = ForeignKeys0.FKHD30FFJT4R86SLV5YETDBV6JN;
    ...
    private static class UniqueKeys0 {
        ...
        public static final UniqueKey<T_NYUKIN_KEIJO_RECORD> CONSTRAINT_A = Internal.createUniqueKey(T_NYUKIN_KEIJO.t_nyukin_keijo, "CONSTRAINT_A", T_NYUKIN_KEIJO.t_nyukin_keijo.nyukin_id);
        ...
        public static final UniqueKey<T_URIKAKE_MISEIKYU_RECORD> CONSTRAINT_BB = Internal.createUniqueKey(T_URIKAKE_MISEIKYU.t_urikake_miseikyu, "CONSTRAINT_BB", T_URIKAKE_MISEIKYU.t_urikake_miseikyu.urikake_id);
        public static final UniqueKey<T_URIKAKE_MISEIKYU_RECORD> UK_QQQ9XMCG11YHYLQRK9YA2XCVV = Internal.createUniqueKey(T_URIKAKE_MISEIKYU.t_urikake_miseikyu, "UK_QQQ9XMCG11YHYLQRK9YA2XCVV", T_URIKAKE_MISEIKYU.t_urikake_miseikyu.record_id);
        public static final UniqueKey<T_URIKAKE_SEIKYU_RECORD> CONSTRAINT_3 = Internal.createUniqueKey(T_URIKAKE_SEIKYU.t_urikake_seikyu, "CONSTRAINT_3", T_URIKAKE_SEIKYU.t_urikake_seikyu.urikake_id);
        public static final UniqueKey<T_URIKAKE_SEIKYU_RECORD> UK_HYXD5QG5HAQQWADYTUFGUG75 = Internal.createUniqueKey(T_URIKAKE_SEIKYU.t_urikake_seikyu, "UK_HYXD5QG5HAQQWADYTUFGUG75", T_URIKAKE_SEIKYU.t_urikake_seikyu.record_id);
    ...
    private static class ForeignKeys0 {
        ...
        public static final ForeignKey<T_URIKAKE_MISEIKYU_RECORD, T_URIKAKE_RECORD> FKLBHEN31UWEW3FUTAVYU3EA9UI = Internal.createForeignKey(com.showka.table.public_.Keys.UK_3RCPSMXXRKKRO42FWTDIPIAXB, T_URIKAKE_MISEIKYU.t_urikake_miseikyu, "FKLBHEN31UWEW3FUTAVYU3EA9UI", T_URIKAKE_MISEIKYU.t_urikake_miseikyu.urikake_id);
        public static final ForeignKey<T_URIKAKE_SEIKYU_RECORD, T_URIKAKE_RECORD> FKR1R0G487FGYWJ0QDOO4YYA62U = Internal.createForeignKey(com.showka.table.public_.Keys.UK_3RCPSMXXRKKRO42FWTDIPIAXB, T_URIKAKE_SEIKYU.t_urikake_seikyu, "FKR1R0G487FGYWJ0QDOO4YYA62U", T_URIKAKE_SEIKYU.t_urikake_seikyu.urikake_id);
        public static final ForeignKey<T_URIKAKE_SEIKYU_RECORD, T_SEIKYU_RECORD> FKHD30FFJT4R86SLV5YETDBV6JN = Internal.createForeignKey(com.showka.table.public_.Keys.UK_4SCPAF4QMJRAM1VXMKUYJ269J, T_URIKAKE_SEIKYU.t_urikake_seikyu, "FKHD30FFJT4R86SLV5YETDBV6JN", T_URIKAKE_SEIKYU.t_urikake_seikyu.seikyu_id);
