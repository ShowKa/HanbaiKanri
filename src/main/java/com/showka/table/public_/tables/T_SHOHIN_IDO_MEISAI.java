...
public class T_SHOHIN_IDO_MEISAI extends TableImpl<T_SHOHIN_IDO_MEISAI_RECORD> {
    ...
    private static final long serialVersionUID = 1848522059;
     ...
     */
    public final TableField<T_SHOHIN_IDO_MEISAI_RECORD, Timestamp> CREATE_TIMESTAMP = createField("CREATE_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP()", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
     ...
     */
    public final TableField<T_SHOHIN_IDO_MEISAI_RECORD, Timestamp> UPDATE_TIMESTAMP = createField("UPDATE_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP()", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.FKNYESTD5U0GAEDM2AUNTF943D1_INDEX_2, Indexes.FKP0LRETW08695Q1FOIS2EK6Q6B_INDEX_2, Indexes.PRIMARY_KEY_25, Indexes.UK_QMKOJB8N58COAAOK60IQVBJ5B_INDEX_2);
    }
