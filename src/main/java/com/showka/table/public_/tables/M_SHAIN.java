...
public class M_SHAIN extends TableImpl<M_SHAIN_RECORD> {
    ...
    private static final long serialVersionUID = -641767332;
     ...
     */
    public final TableField<M_SHAIN_RECORD, Timestamp> CREATE_TIMESTAMP = createField("CREATE_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP()", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
     ...
     */
    public final TableField<M_SHAIN_RECORD, Timestamp> UPDATE_TIMESTAMP = createField("UPDATE_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP()", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.FK6EXWC57AN76H9BS794TJGTUGN_INDEX_9, Indexes.PRIMARY_KEY_9, Indexes.UK_81PKBX9M7PBAFUMTCUKHTOOBH_INDEX_9);
    }
