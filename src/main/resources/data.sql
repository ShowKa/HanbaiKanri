...
VALUES
('r-001', to_date('2017/08/19', 'yyyy/MM/dd'), to_date('2017/08/19', 'yyyy/MM/dd'), 1000,'r-001', 'r-KK02-00001', 'r-001'),
('r-002', to_date('2017/08/19', 'yyyy/MM/dd'), to_date('2017/08/19', 'yyyy/MM/dd'), 1000,'r-002', 'r-KK02-00001', 'r-002'),
;
-- 商品在庫
