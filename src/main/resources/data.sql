...
VALUES
('r-BS01', to_date('2018/09/20', 'yyyy/MM/dd'), 'r-BS01'),
('r-BS02', to_date('2018/09/20', 'yyyy/MM/dd'), 'r-BS02'),
;
...
VALUES
-- 顧客01, 販売区分=現金
('r-KK01', '00001', to_date('2018/09/19', 'yyyy/MM/dd'), to_date('2018/09/19', 'yyyy/MM/dd'), '00', 0.08, 'r-KK01-00001'),
-- 顧客02, 販売区分=掛売
('r-KK02', '00001', to_date('2018/09/20', 'yyyy/MM/dd'), to_date('2018/09/20', 'yyyy/MM/dd'), '10', 0.08, 'r-KK02-00001'),
('r-KK02', '00002', to_date('2018/09/20', 'yyyy/MM/dd'), to_date('2018/09/20', 'yyyy/MM/dd'), '10', 0.08, 'r-KK02-00002'),
;
...
('r-KK01-00001', to_date('2018/09/19', 'yyyy/MM/dd'), to_date('2018/09/19', 'yyyy/MM/dd'), '00', 0.08, 'r-KK01-00001-20180919'),
('r-KK01-00001', to_date('2018/09/19', 'yyyy/MM/dd'), to_date('2018/09/20', 'yyyy/MM/dd'), '00', 0.08, 'r-KK01-00001-20180920'),
-- 顧客02, 伝票番号=00001, 販売区分=掛売
('r-KK02-00001', to_date('2018/09/20', 'yyyy/MM/dd'), to_date('2018/09/20', 'yyyy/MM/dd'), '10', 0.08, 'r-KK02-00001-20180920'),
-- 顧客02, 伝票番号=00002, 販売区分=掛売
('r-KK02-00002', to_date('2018/09/20', 'yyyy/MM/dd'), to_date('2018/09/20', 'yyyy/MM/dd'), '10', 0.08, 'r-KK02-00002-20180920'),
;
...
('r-KK01-00001-20180919', 1, 'r-SH01', 4, 1000, 'r-KK01-00001-20180919-1'),
('r-KK01-00001-20180919', 2, 'r-SH02', 4, 1001, 'r-KK01-00001-20180919-2'),
-- 顧客01, 伝票番号=00001 19日計上分明細（訂正後）
('r-KK01-00001-20180920', 1, 'r-SH01', 5, 1000, 'r-KK01-00001-20180920-1'),
('r-KK01-00001-20180920', 2, 'r-SH02', 5, 1001, 'r-KK01-00001-20180920-2'),
-- 顧客02, 伝票番号=00001
('r-KK02-00001-20180920', 1, 'r-SH01', 10, 1000, 'r-KK02-00001-20180920-1'),
('r-KK02-00001-20180920', 2, 'r-SH02', 10, 1001, 'r-KK02-00001-20180920-2'),
-- 顧客02, 伝票番号=00002
('r-KK02-00002-20180920', 1, 'r-SH01', 10, 1000, 'r-KK02-00002-20180920-2'),
;
...
VALUES
('r-KK01-00001-20180919', 'r-BS01', 'r-KK01-00001-20180919'),
;
...
VALUES
-- 翌月9/30入金予定
('r-KK02-00001', 21610, to_date('2018/10/30', 'yyyy/MM/dd') ,'r-KK02-00001'),
...
VALUES
('r-001', 'r-KK02', 'r-BS02', to_date('2018/09/20', 'yyyy/MM/dd'), '10', 21610, 'r-001'),
('r-002', 'r-KK02', 'r-BS02', to_date('2018/09/20', 'yyyy/MM/dd'), '10', 10800, 'r-002'),
('r-003', 'r-KK01', 'r-BS01', to_date('2018/09/20', 'yyyy/MM/dd'), '00', 10800, 'r-003'),
;
...
VALUES
('r-BS01', to_date('2018/09/20', 'yyyy/MM/dd'), 'r-SH01', 100, 'r-BS01-20180920-SH01'),
('r-BS01', to_date('2018/09/20', 'yyyy/MM/dd'), 'r-SH02', 101, 'r-BS01-20180920-SH02'),
('r-BS01', to_date('2018/09/20', 'yyyy/MM/dd'), 'r-SH03', 102, 'r-BS01-20180920-SH03'),
('r-BS02', to_date('2018/09/20', 'yyyy/MM/dd'), 'r-SH01', 200, 'r-BS02-20180920-SH01'),
('r-BS02', to_date('2018/09/20', 'yyyy/MM/dd'), 'r-SH02', 201, 'r-BS02-20180920-SH02'),
('r-BS02', to_date('2018/09/20', 'yyyy/MM/dd'), 'r-SH03', 202, 'r-BS02-20180920-SH03'),
;
...
VALUES
-- 売上
('r-001', 'r-BS01', to_date('2018/09/20', 'yyyy/MM/dd'), '10', CURRENT_TIMESTAMP(), 'r-001'),
-- 入荷
('r-002', 'r-BS01', to_date('2018/09/20', 'yyyy/MM/dd'), '00', CURRENT_TIMESTAMP(), 'r-002'),
;
